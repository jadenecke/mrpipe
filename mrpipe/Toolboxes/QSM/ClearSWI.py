...
class ClearSWI(Task):
    ...
    def __init__(self, session, mag4d_path: Path, pha4d_path: Path, TEms: List[float], outputDir: Path,  outputFiles: List[Path], clearswiSIF, unwrapping_algorithm: str = "laplacian", name: str = "clearswi", clobber=False):
