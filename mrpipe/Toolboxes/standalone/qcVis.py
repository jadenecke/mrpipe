...
class QCVis(Task):
    ...
    def __init__(self, infile, mask, image, sliceNumber: int = 6, subject: str = None, session: str = None, tempDir=None, zoom: int = 1, checkerboard=False, outline=True, contrastAdjustment=True, transparency=None, name: str = "QCVis", verbose=False, clobber=False):
