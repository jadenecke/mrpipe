...
class T1w_1mm(ProcessingModule):
    ...
    def setup(self) -> bool:
        ...
        self.T1w_1mm_synthsegGM(self.moduleDependenciesDict["T1w_SynthSeg"].GMmerge)
        self.T1w_1mm_synthsegWM(self.moduleDependenciesDict["T1w_SynthSeg"].WMmerge)
        self.T1w_1mm_synthsegCSF(self.moduleDependenciesDict["T1w_SynthSeg"].CSFmerge)
        self.T1w_1mm_synthsegGMCortical(self.moduleDependenciesDict["T1w_SynthSeg"].GMCorticalmerge)
        self.T1w_1mm_synthsegWMCortical(self.moduleDependenciesDict["T1w_SynthSeg"].WMCorticalmerge)
...
class T1w_1p5mm(ProcessingModule):
    ...
    def setup(self) -> bool:
        ...
        self.T1w_1p5mm_synthsegGM(self.moduleDependenciesDict["T1w_SynthSeg"].GMmerge)
        self.T1w_1p5mm_synthsegWM(self.moduleDependenciesDict["T1w_SynthSeg"].WMmerge)
        self.T1w_1p5mm_synthsegCSF(self.moduleDependenciesDict["T1w_SynthSeg"].CSFmerge)
        self.T1w_1p5mm_synthsegGMCortical(self.moduleDependenciesDict["T1w_SynthSeg"].GMCorticalmerge)
        self.T1w_1p5mm_synthsegWMCortical(self.moduleDependenciesDict["T1w_SynthSeg"].WMCorticalmerge)
...
class T1w_2mm(ProcessingModule):
    ...
    def setup(self) -> bool:
        ...
        self.T1w_2mm_synthsegGM(self.moduleDependenciesDict["T1w_SynthSeg"].GMmerge)
        self.T1w_2mm_synthsegWM(self.moduleDependenciesDict["T1w_SynthSeg"].WMmerge)
        self.T1w_2mm_synthsegCSF(self.moduleDependenciesDict["T1w_SynthSeg"].CSFmerge)
        self.T1w_2mm_synthsegGMCortical(self.moduleDependenciesDict["T1w_SynthSeg"].GMCorticalmerge)
        self.T1w_2mm_synthsegWMCortical(self.moduleDependenciesDict["T1w_SynthSeg"].WMCorticalmerge)
...
class T1w_3mm(ProcessingModule):
    ...
    def setup(self) -> bool:
        ...
        self.T1w_3mm_synthsegGM(self.moduleDependenciesDict["T1w_SynthSeg"].GMmerge)
        self.T1w_3mm_synthsegWM(self.moduleDependenciesDict["T1w_SynthSeg"].WMmerge)
        self.T1w_3mm_synthsegCSF(self.moduleDependenciesDict["T1w_SynthSeg"].CSFmerge)
        self.T1w_3mm_synthsegGMCortical(self.moduleDependenciesDict["T1w_SynthSeg"].GMCorticalmerge)
        self.T1w_3mm_synthsegWMCortical(self.moduleDependenciesDict["T1w_SynthSeg"].WMCorticalmerge)
