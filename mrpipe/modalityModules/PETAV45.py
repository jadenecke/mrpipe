...
class PETAV45_base_withT1w(ProcessingModule):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.petav45_base_recenter = PipeJobPartial(name="PETAV45_base_recenterToCom", job=SchedulerPartial(
            taskList=[CP(infile=session.subjectPaths.pet_av45.bids.PETAV45.imagePath,
                         outfile=session.subjectPaths.pet_av45.bids_processed.PETAV45_recentered,
        ...
        self.petav45_base_fromT1w_schaefer100_7Net = PipeJobPartial(name="PETAV45_base_fromT1w_schaefer100_7Net", job=SchedulerPartial(
            taskList=[AntsApplyTransforms(input=session.subjectPaths.T1w.bids_processed.Schaefer2018_100Parcels_7Networks_order_FSLMNI152_gmMasked,
                                          output=session.subjectPaths.pet_av45.bids_processed.atlas_schaefer100_7Net,
                                          reference=session.subjectPaths.pet_av45.bids_processed.PETAV45_recentered,
                                          transforms=[session.subjectPaths.pet_av45.bids_processed.toT1w_0GenericAffine],
                                          inverse_transform=[True],
                                          interpolation="NearestNeighbor",
        ...
        self.petav45_base_suvr_statsSchaefer100_7 = PipeJobPartial(name="PETAV45_base_SUVR_statsSchaefer100_7", job=SchedulerPartial(
            taskList=[ExtractAtlasValues(infile=session.subjectPaths.pet_av45.bids_processed.SUVR,
                                         atlas=session.subjectPaths.pet_av45.bids_processed.atlas_schaefer100_7Net,
                                         outfile=session.subjectPaths.pet_av45.bids_statistics.SUVR_WHOLECER_Schaefer100_7Net_mean,
                                         func="mean",
                                         session=session) for session in self.sessions]), env=self.envs.envR)
        ...
        self.petav45_base_suvrToCentiloid_Schaefer100_7 = PipeJobPartial(name="PETAV45_base_SUVRToCentiloid_Schaefer100_7", job=SchedulerPartial(
            taskList=[SUVRToCentiloid(infile=session.subjectPaths.pet_av45.bids_statistics.SUVR_WHOLECER_Schaefer100_7Net_mean,
                                      outfile=session.subjectPaths.pet_av45.bids_statistics.Centiloid_WHOLECER_Schaefer100_7Net_mean,
                                      tracerName="AV45",
                                      session=session) for session in self.sessions]), env=self.envs.envR)
